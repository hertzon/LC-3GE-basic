...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final SeekBar potenciometro=(SeekBar) findViewById(R.id.potenciometro);
        final TextView potencia= (TextView) findViewById(R.id.potencia);
        
        potenciometro.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			public void onProgressChanged(SeekBar seekBar, int progress,
					boolean fromUser) {
				// TODO Auto-generated method stub
				potencia.setText("Potencia: "+progress);
				if (progress>94){
					progress=94;
				}
				sendMessage(progress+"\r");
//				if (progress>80){
//					findViewById(R.id.Led1).setBackgroundResource(R.drawable.bulbon);
//					findViewById(R.id.Led1).setPressed(true);
//				}else {
//					findViewById(R.id.Led1).setPressed(false);
//				}
     	...
     	BotonLed.setOnClickListener(new View.OnClickListener() {
				public void onClick(View vv) {   
					...
					if(BotonLed.isChecked())     {
						 ...
						 sendMessage("90\r");
						 findViewById(R.id.Led1).setBackgroundResource(R.drawable.bulbon);	
						 potenciometro.setProgress(100);
					}	                	
					else {
						 if(D) Log.e("BotonLed", "Apagando..");
						 sendMessage("2\r");
						 findViewById(R.id.Led1).setBackgroundResource(R.drawable.bulboff);
						 potenciometro.setProgress(0);
					}	                            
				}
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.Conexion:
        	if(D) Log.e("conexion", "conectandonos");        	     
	                 ...
	                 String address = "98:D3:31:20:18:29";//Direccion Mac HC05
